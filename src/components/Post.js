...
export default function Post({ meta, children, posts }) {
  ...
  return (
    <article className="xl:divide-y xl:divide-gray-200">
      <Head>
        <title>{meta.title} – Fidum</title>
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@danmasonmp" />
        <meta name="twitter:creator" content="@danmasonmp" />
        <meta name="twitter:title" content={`${meta.title} – Fidum`} />
        <meta name="twitter:description" content={meta.description} />
        <meta name="twitter:image" content={`https://fidum.uk${meta.image}`} />
        <meta property="og:url" content={`https://fidum.uk${router.pathname}`} />
        <meta property="og:type" content="article" />
        <meta property="og:title" content={`${meta.title} – Fidum`} />
        <meta property="og:description" content={meta.description} />
        <meta property="og:image" content={`https://fidum.uk${meta.image}`} />
      ...
      >
        <dl className="pt-6 pb-10 xl:pt-11 xl:border-b xl:border-gray-200 md:mr-5">
        ...
        <footer className="text-sm font-medium leading-5 divide-y divide-gray-200 xl:col-start-1 xl:row-start-2">
          ...
          <div className="pt-8">
            <Link href="/">
              <a className="text-cyan-500 hover:text-cyan-300">&larr; Back to the blog</a>
            </Link>
          </div>
        </footer>
      </div>
